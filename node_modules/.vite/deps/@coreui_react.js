...
var CFocusTrap = ({ active = true, additionalContainer, children, focusFirstElement = false, onActivate, onDeactivate, restoreFocus = true }) => {
  ...
  const prevFocusedRef = (0, import_react45.useRef)(null);
  const isActiveRef = (0, import_react45.useRef)(false);
  const lastTabNavDirectionRef = (0, import_react45.useRef)("forward");
  const tabEventSourceRef = (0, import_react45.useRef)(null);
  ...
  const onlyChild = import_react45.default.Children.only(children);
  const childRef = onlyChild.ref;
  const mergedRef = mergeRefs(childRef, (node) => {
    containerRef.current = node;
  });
  return (0, import_react45.cloneElement)(onlyChild, { ref: mergedRef });
};

// node_modules/@coreui/react/dist/esm/components/dropdown/CDropdown.js
var CDropdown = (0, import_react46.forwardRef)((_a, ref) => {
  ...
  const dropdownRef = (0, import_react46.useRef)(null);
  const dropdownMenuRef = (0, import_react46.useRef)(null);
  const forkedRef = useForkedRef(ref, dropdownRef);
  const [dropdownToggleElement, setDropdownToggleElement] = (0, import_react46.useState)(null);
  const [pendingKeyDownEvent, setPendingKeyDownEvent] = (0, import_react46.useState)(null);
  const [_visible, setVisible] = (0, import_react46.useState)(visible);
  const { initPopper, destroyPopper } = usePopper();
  const dropdownToggleRef = (0, import_react46.useCallback)((node) => {
    if (node) {
  ...
  const computedPopperConfig = (0, import_react46.useMemo)(() => {
  ...
  const handleKeyup = (0, import_react46.useCallback)((event) => {
    if (autoClose === false) {
      return;
    }
    if (event.key === "Escape") {
  ...
  const handleShow = (0, import_react46.useCallback)((event) => {
    const menuElement = dropdownMenuRef.current;
    const referenceElement = getReferenceElement(reference2, dropdownToggleElement, dropdownRef);
    const toggleElement = dropdownToggleElement;
  ...
  const contextValues = (0, import_react46.useMemo)(() => ({
    alignment,
    container,
    dark,
    dropdownMenuRef,
  ...
  return import_react46.default.createElement(
    ...
    { value: contextValues },
    import_react46.default.createElement(CFocusTrap, { active: portal && _visible, additionalContainer: dropdownMenuRef, restoreFocus: true }, variant === "input-group" ? import_react46.default.createElement(import_react46.default.Fragment, null, children) : import_react46.default.createElement(Component, Object.assign({ className: classNames(variant === "nav-item" ? "nav-item dropdown" : variant, {
...
var CDropdownDivider = (0, import_react47.forwardRef)((_a, ref) => {
  var { className } = _a, rest = __rest(_a, ["className"]);
  return import_react47.default.createElement("hr", Object.assign({ className: classNames("dropdown-divider", className) }, rest, { ref }));
});
...
var CDropdownHeader = (0, import_react48.forwardRef)((_a, ref) => {
  var { children, as: Component = "h6", className } = _a, rest = __rest(_a, ["children", "as", "className"]);
  return import_react48.default.createElement(Component, Object.assign({ className: classNames("dropdown-header", className) }, rest, { ref }), children);
});
...
var CDropdownItem = (0, import_react49.forwardRef)((_a, ref) => {
  var { children, as = "a", className } = _a, rest = __rest(_a, ["children", "as", "className"]);
  return import_react49.default.createElement(CLink, Object.assign({ className: classNames("dropdown-item", className), as }, rest, { ref }), children);
});
...
var CDropdownItemPlain = (0, import_react50.forwardRef)((_a, ref) => {
  var { children, as: Component = "span", className } = _a, rest = __rest(_a, ["children", "as", "className"]);
  return import_react50.default.createElement(Component, Object.assign({ className: classNames("dropdown-item-text", className) }, rest, { ref }), children);
});
...
var CDropdownMenu = (0, import_react51.forwardRef)((_a, ref) => {
  var { children, as: Component = "ul", className } = _a, rest = __rest(_a, ["children", "as", "className"]);
  const { alignment, container, dark, dropdownMenuRef, popper: popper2, portal, visible } = (0, import_react51.useContext)(CDropdownContext);
  ...
  return import_react51.default.createElement(
    ...
    import_react51.default.createElement(Component, Object.assign({ className: classNames("dropdown-menu", {
      show: visible
    }, alignment && getAlignmentClassNames(alignment), className), ref: forkedRef, role: "menu" }, !popper2 && { "data-coreui-popper": "static" }, dark && { "data-coreui-theme": "dark" }, rest), Component === "ul" ? import_react51.default.Children.map(children, (child, index) => {
      if (import_react51.default.isValidElement(child)) {
        return import_react51.default.createElement("li", { key: index }, import_react51.default.cloneElement(child));
      }
      return;
    }) : children)
  );
...
var CDropdownToggle = (_a) => {
  ...
  const { dropdownToggleRef, handleHide, handleShow, variant, visible } = (0, import_react52.useContext)(CDropdownContext);
  ...
  if (custom && import_react52.default.isValidElement(children)) {
    return import_react52.default.createElement(import_react52.default.Fragment, null, import_react52.default.cloneElement(children, Object.assign(Object.assign({ "aria-expanded": visible }, !rest.disabled && Object.assign({}, triggers)), { ref: dropdownToggleRef })));
  }
  if (variant === "nav-item" && navLink) {
    return import_react52.default.createElement("a", Object.assign({ href: "#" }, togglerProps, { role: "button" }, rest, { ref: dropdownToggleRef }), children);
  }
  return import_react52.default.createElement(
    CButton,
    Object.assign({}, togglerProps, { tabIndex: 0 }, rest, { ref: dropdownToggleRef }),
    children,
    split && import_react52.default.createElement("span", { className: "visually-hidden" }, splitLabel)
  );
};
